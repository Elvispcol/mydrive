...
import { PreoperacionalDetallePage } from '@/features/preoperacional/PreoperacionalDetallePage'
...
export default async function Page({ params }: { params: Promise<{ locale: Locale; id: string }> }) {
  ...
  return (
    <PreoperacionalDetallePage
      preoperacionalId={id}
      locale={locale}
      rol="director"
      nombre={perfil.nombre}
      basePath={`/${locale}/director/preoperacionales`}
    />
  )
}
