...
import { EditarMultaPage } from '@/features/multas/EditarMultaPage'
...
export default async function Page({ params }: { params: Promise<{ locale: Locale; id: string }> }) {
  ...
  return <EditarMultaPage multaId={id} locale={locale} rol={perfil.rol as 'admin_apoyo' | 'director'} nombre={perfil.nombre} basePath={`/${locale}/admin/multas`} />
}
