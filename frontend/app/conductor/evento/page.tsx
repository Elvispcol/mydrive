...
const TIPOS_EVENTO = ['Choque / colisión', 'Daño mecánico', 'Robo / intento de robo', 'Accidente personal', 'Otro']
...
export default function EventoPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Llamar Edge Function para crear novedad y enviar correo
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-sm w-full text-center">
          ...
          <p className="text-sm text-gray-500 mt-2">El administrador fue notificado y se creó una novedad en el tablero.</p>
