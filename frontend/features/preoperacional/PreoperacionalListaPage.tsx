          ...
          {preoperacionales.length === 0 ? (
            ...
            <div className="bg-surface rounded-xl border border-border overflow-hidden">
              <div className="grid grid-cols-[2fr_1fr_1fr_auto] gap-4 px-4 py-2.5 border-b border-border bg-surface-raised">
                <span className="text-[11px] font-medium text-ink-500">Conductor</span>
                <span className="text-[11px] font-medium text-ink-500">Vehículo</span>
                <span className="text-[11px] font-medium text-ink-500">Resultado</span>
                <span />
              </div>
