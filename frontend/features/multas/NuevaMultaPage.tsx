...
export async function NuevaMultaPage({ locale, rol, nombre, basePath }: Props) {
    ...
    <div className="flex h-full">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="p-8 max-w-3xl mx-auto">
          ...
          <PageHeader title="Registrar infracción" subtitle="Registra una multa o infracción de tránsito" actions={<LogoutButton />} />
          <MultaForm vehiculos={vehiculos} conductores={conductores} backHref={basePath} successHref={basePath} />
        </div>
      </main>
    </div>
  )
